...
- If a headless-front sheet repair fails once, use the canonical character standard's complete-front-head fallback instead of repeating provider edits; record the layout so the later Seedance binding is truthful.
