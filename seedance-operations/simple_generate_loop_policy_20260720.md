...
2. VERIFY: Safari-visible thumbnail count/order.
...
4. If Generate is blue **and** eight checks pass: click Generate **once**.
...
8. Do not open Chrome Runway for the same project while on this branch.
